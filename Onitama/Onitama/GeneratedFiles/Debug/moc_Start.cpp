...
QT_MOC_LITERAL(4, 22, 21) // "on_pushButton_clicked"
    ...
    "Start\0display\0\0number\0on_pushButton_clicked"
};
...
void Start::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Start::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Start::display)) {
                *result = 0;
                return;
            }
        }
